...
// OVERRIDE: Force correct Supabase project, ignore wrong Vercel integration env vars
// Vercel's Supabase integration keeps pointing to the wrong project (enzrmswhjktmmzcrqthz)
// We need the correct project (hfmggtnhgilxzbcmigpi), so bypass all environment variables
const connectionString = 'postgres://postgres:NewLIFE2028**@db.hfmggtnhgilxzbcmigpi.supabase.co:6543/postgres';
console.log('[db] ⚠️ HARDCODED CONNECTION STRING IN USE (Vercel env var bypass)');
