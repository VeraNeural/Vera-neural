...
// FORCE correct Supabase project - NEVER fallback to old environment variables
// Project: hfmggtnhgilxzbcmigpi (CORRECT - new project)
// Hardcoded to prevent accidental use of OLD environment variables still in Vercel
const connectionString = 'postgres://postgres.hfmggtnhgilxzbcmigpi:NewLIFE2028**@aws-1-us-east-1.pooler.supabase.com:6543/postgres?sslmode=require';
console.log('[db] ✅ CONNECTION STRING HARDCODED - Project: hfmggtnhgilxzbcmigpi (NEW) - VERCEL OVERRIDE ACTIVE');
