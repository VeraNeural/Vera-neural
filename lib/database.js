...
// Priority order: Try environment variables first, then hardcoded fallback to correct Supabase project
const connectionString =
  process.env.POSTGRES_URL ||  // Try direct DB URL first
  process.env.POSTGRES_URL_NON_POOLING ||
  process.env.DATABASE_URL ||
  'postgres://postgres:NewLIFE2028**@db.hfmggtnhgilxzbcmigpi.supabase.co:6543/postgres'; // Fallback to correct Supabase project (hfmggtnhgilxzbcmigpi)
