...
// OVERRIDE: Force correct Supabase project (supabase-orange-garden)
// Hardcoded connection string to bypass Vercel's Supabase integration
// Project: enzrmswhjktmmzcrqthz, Host: aws-1-us-east-1.pooler.supabase.com
const connectionString = 'postgres://postgres.enzrmswhjktmmzcrqthz:NewLIFE2028**@aws-1-us-east-1.pooler.supabase.com:6543/postgres';
console.log('[db] ⚠️ HARDCODED CONNECTION STRING IN USE (Vercel env var bypass) - Project: supabase-orange-garden');
...
const dbProject = connectionString.includes('hfmggtnhgilxzbcmigpi') ? 'CORRECT (hfmggtnhgilxzbcmigpi)' : 
                  connectionString.includes('enzrmswhjktmmzcrqthz') ? 'OLD (enzrmswhjktmmzcrqthz)' : 'UNKNOWN';
